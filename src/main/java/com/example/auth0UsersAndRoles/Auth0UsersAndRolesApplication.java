...
public class Auth0UsersAndRolesApplication {
	...
	// 		rolAdminDTO.setDescription("Administrador general");

	// 		RoleDTO rolYediDTO = new RoleDTO();
	// 		rolYediDTO.setName("yedi");
	// 		rolYediDTO.setDescription("Usuario Yedi");

	// 		RoleDTO rolSithDTO = new RoleDTO();
	// 		rolSithDTO.setName("sith");
	// 		rolSithDTO.setDescription("Usuario Sith");

	// 		RoleDTO rolCivilianDTO = new RoleDTO();
	// 		rolCivilianDTO.setName("civilian");
	// 		rolCivilianDTO.setDescription("Usuario Civilian");

	// 		// ==== 1. Crear Roles ====
	// 		crearRolInicial(rolAdminDTO, roleService, roleServicebbdd);
	// 		crearRolInicial(rolYediDTO, roleService, roleServicebbdd);
	// 		crearRolInicial(rolSithDTO, roleService, roleServicebbdd);
	// 		crearRolInicial(rolCivilianDTO, roleService, roleServicebbdd);

	// 		// ==== 2. Crear Usuario Administrador ====
	// 		Roles rolAdmin = roleServicebbdd.findByName("administrador");

	// 		UserDTO adminDTO = new UserDTO();
	// 		adminDTO.setEmail("admin@starwars.com");
